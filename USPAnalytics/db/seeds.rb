...
tabelaD = [
	...
	["Ativo",                grupo1d, tabelaD[1], 2777135.53,  51,85],
	["Aposentados (SPPREV)", grupo1d, tabelaD[1], 1015014.938, 18,95],
	...
	["Unidades de Ensino ",       grupo2d, tabelaD[6], 56455,      1.05],
	["Institutos Especializados", grupo2d, tabelaD[6], 1705,       0.03],
	["Museus",                    grupo2d, tabelaD[6], 3051,       0.06],
	["Hospitais e Anexos",        grupo2d, tabelaD[6], 14610,      0.27],
	["Órgãos  de Apoio",          grupo2d, tabelaD[6], 10424,      0.19],
	["Órgãos  de Serviço",        grupo2d, tabelaD[6], 1564,       0.03],
	["Prefeituras",               grupo2d, tabelaD[6], 7737,       0.14],
	#### GRUPO 2.2
	["Adicionais", 				 		 					  grupo2d, nil, 	   		253377, 	 4.73],
	["Treinamento de Recursos Humanos",  					  grupo2d, tabelaD[14], 	1340.982,    0.03],
	["Manutenção Predial", 									  grupo2d, tabelaD[14], 	25269.97, 	 0.47],
	["Manutenção de Áreas Externas", 	 					  grupo2d, tabelaD[14], 	3354.962, 	 0.06],
	["Manutenção de Sistema Viário", 	 					  grupo2d, tabelaD[14], 	3360.967, 	 0.06],
	["Equipamentos Segurança", 			 					  grupo2d, tabelaD[14], 	3790.497, 	 0.07],
	["Manutenção e Reposição de Equipamentos de Informática", grupo2d, tabelaD[14], 	8658.171, 	 0.16],
	["Serviços de Limpeza e de Vigilância", 				  grupo2d, tabelaD[14], 	195553.66,   3.65],
	["Despesas com Transporte", 							  grupo2d, tabelaD[14], 	9174.879, 	 0.17],
	["Aluguel imóveis", 									  grupo2d, tabelaD[14],		2874.08, 	 0.05],
	#### GRUPO 2.3
	...
	["Graduação",            grupo2d, tabelaD[26], 10294,      0,19],
	["Pós-Gradução",         grupo2d, tabelaD[26], 1101,       0.02],
	["Pesquisa",             grupo2d, tabelaD[26], 2161,       0.04],
	["Cultura e Extensão",   grupo2d, tabelaD[26], 1338,       0.02],
	["Reitoria",             grupo2d, tabelaD[26], 1992,       0.04],
	#### GRUPO 2.6
	["Reservas Específicas", grupo2d, nil,                    400,       0.01],
	#### GRUPO 2.7
	["Atividades Integradas",                          grupo2d, nil,                     257906,    4.81],
	["Avaliação Institucional",                        grupo2d, tabelaD[33], 247,       0.00],
	["Assistência Médica e Odontológica",              grupo2d, tabelaD[33], 27697.724, 0.52],
	["Material Bibliográfico",                         grupo2d, tabelaD[33], 12000,     0.22],
	["Cooperação Acadêmica Nacional e Internacional",  grupo2d, tabelaD[33], 1838.2,    0.03],
	["Obras",                                          grupo2d, tabelaD[33], 40540,     0.76],
	["Biotérios",                                      grupo2d, tabelaD[33], 6000,      0.11],
	["Programa Integrado de Segurança",                grupo2d, tabelaD[33], 6000,      0.11],
	["Informática",                                    grupo2d, tabelaD[33], 20000,     0.37],
	["Restaurantes Universitários",                    grupo2d, tabelaD[33], 37922,     0.71],
	["Creches",                                        grupo2d, tabelaD[33], 1440,      0.03],
	["Serviços de Utilidade Pública",                  grupo2d, tabelaD[33], 98094,     1.83],
	["Sistema de Frota de Veículos",                   grupo2d, tabelaD[33], 1063,      0.02],
	["Renovação da Frota de Veículos Especiais",       grupo2d, tabelaD[33], 500,       0.01],
	["Taxas Municipais",                               grupo2d, tabelaD[33], 1669,      0.03],
	["Escola Técnica e de Gestão da USP",              grupo2d, tabelaD[33], 670,       0.01],
	["Reservas Ecológicas",                            grupo2d, tabelaD[33], 2000,      0.04],
	["Taxas para proteção à propriedade intelectual",  grupo2d, tabelaD[33], 225,       0.00],
	#### GRUPO 3
