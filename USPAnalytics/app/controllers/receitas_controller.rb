class ReceitasController < ApplicationController
  ...
  private
    ...
    def receita_params
      params.require(:receita).permit(:receita_tesouro_estado, :receita_propria_nao_vinculada, :rendimento_aplicacoes, :reembolsos, :outras_receitas, :receitas_vinculadas, :ano)
    end
end
